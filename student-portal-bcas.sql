...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2024 at 08:00 AM
...
(3, 'Administrator', 'bautistadominic60@gmail.com', '123456789');
...
--
ALTER TABLE `tbl_forgotpassword`
  ADD CONSTRAINT `tbl_forgotpassword_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `tbl_admin` (`admin_id`),
  ADD CONSTRAINT `tbl_forgotpassword_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `tbl_student` (`student_id`);
...
ALTER TABLE `tbl_student`
  ...
  ADD CONSTRAINT `tbl_student_ibfk_3` FOREIGN KEY (`section_id`) REFERENCES `tbl_section` (`section_id`);
COMMIT;
