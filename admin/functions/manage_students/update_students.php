...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email_exist) {
        ...
        if (in_array($file_type, $allow_types)) {
            ...
            $update_stmt->execute([$year_id, $course_id, $section_id, $student_fullname, $student_email, $student_address, $student_contact, $password, $file_name, $student_id]);
        } else {
        ...
        $update_stmt->execute([$year_id, $course_id, $section_id, $student_fullname, $student_email, $student_address, $student_contact, $password, $student_id]);
    }
