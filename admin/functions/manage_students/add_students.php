...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email_exist || $student_no_exist) {
        ...
        INSERT INTO `tbl_student` (student_no, student_fullname, student_email, student_password, student_contact, student_address, marks, year_id, course_id, section_id, student_profile) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
    ");

        $insert_stmt->execute([$student_no, $student_fullname, $student_email, $password, $student_contact, $student_address, $marks, $year_id, $course_id, $section_id, $file_name]);
