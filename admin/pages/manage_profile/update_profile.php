...
$sql_admin_details = "SELECT email, fullname, password FROM tbl_admin WHERE admin_id = ?";
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">account_circle</i> Update profile</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                        ...
                        <div class="body">
                            ...
                            <form id="form_advanced_validation" action="../../functions/manage_profile/update_profile.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="fullname" value="<?php echo $admin_fullname ?>" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="email" value="<?php echo $admin_email ?>" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="password" maxlength="20" minlength="6" value="<?php echo $admin_password ?>" required>
                                        <label class="form-label">Password</label>
                                    </div>
                                </div>

                                <input class="btn bg-red" type="submit" name="submit" value="Update profile">
                            </form>
                        </div>
                    </div>
                </div>
