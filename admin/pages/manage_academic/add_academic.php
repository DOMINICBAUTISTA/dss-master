    ...
    <div class="container-fluid">
        <div class="block-header">
            <ol class="breadcrumb breadcrumb-col-red">
                ...
                <li><a href="../course.php"><i class="material-icons">book</i> Academic Year</a></li>
                <li class="active"><i class="material-icons">book</i> Add Academic Year</li>
            </ol>
        </div>
        <!-- Advanced Validation -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        ?>
                        <!-- end displaying -->
                        <form id="form_advanced_validation" action="../../functions/manage_academic/add_academic.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="help-info">Ex. 2024-2025</div>
                            </div>

                            <input class="btn bg-red" type="submit" name="submit" value="Add Academic Year">
                        </form>
                    </div>
                </div>
            </div>
