...
if (isset($_GET['section_id'])) {
    ...
    $get_section_stmt = $conn->prepare("SELECT * FROM `tbl_section` WHERE section_id = ?");
    $get_section_stmt->execute([$section_id]);
    $section = $get_section_stmt->fetch(PDO::FETCH_ASSOC);
}
...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTy1TutOUSYZTi6jo2tcOjKDm8zcUU5zz7u-pUNB-CpJgJxrKgJBIVdgfTBIFFfMWqBh3E&usqp=CAU" width="48" height="48" alt="User" />
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">book</i> Update section</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                            <form id="form_advanced_validation" action="../../functions/manage_section/update_section.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="section_id" value="<?php echo $section['section_id'] ?>">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="section_name" value="<?php echo $section['section_name'] ?>" required>
                                        <label class="form-label">Section name</label>
                                    </div>
                                    <div class="help-info">A (Alpha)</div>
