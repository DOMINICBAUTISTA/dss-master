                                    ...
                                    <tbody>
                                        <?php foreach ($students as $student) : ?>
                                            <tr>
                                                ...
                                                <td style="color: green; font-weight: 900;"><?php echo $student['marks'] ?></td>
                                                <td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form id="deleteSoftStudentsForm" class="deleteSoftStudentsForm" data-student-id="<?php echo $student['student_id']; ?>" action="../functions/manage_students/soft_delete_students.php" method="GET">
