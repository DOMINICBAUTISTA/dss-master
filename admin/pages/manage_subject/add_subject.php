        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">book</i> Add subject</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="form_advanced_validation" action="../../functions/manage_subject/add_subject.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="subject_unit" required>
                                ...
                                <input class="btn bg-red" type="submit" name="submit" value="Add subject">
                            </form>
                        </div>
                    </div>
                </div>
