...
<body class="theme-red">
                                    ...
                                    <tbody>
                                        <?php foreach ($students as $student) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo $student['year'] ?> - <?php echo $student['section_name'] ?></td>
                                                <td><?php echo $student['course'] ?></td>
                                                <td style="color: brown; font-weight: 900;"><?php echo $student['marks'] ?></td>
                                                <td>
                                                    <a class="btn bg-red restore-button" href="#" data-student-id="<?php echo $student['student_id']; ?>">Restore</a>
                                                    <a class="btn bg-red" href="#" data-toggle="modal" data-target="#deleteStudentsModal<?php echo $student['student_id'] ?>">Permanent Delete</a>
                                                </td>
                                            </tr>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure you want to delete this student permanently <?php echo $student['student_fullname'] ?>?</p>
                                                        </div>
    ...
    <script src="../ajax/manage_students/restore_students.js"></script>
