...
// Fetch data for tbl_section
$sectionStmt = $conn->query("SELECT * FROM `tbl_section`");
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="form_advanced_validation" class="addStudentsForm" action="../../functions/manage_students/add_students.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select name="section_id" class="form-control show-tick" required>
                                            <option style="color: #0e0e0e !important;" disabled selected>-- Select section --</option>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <select name="course_id" class="form-control show-tick" required>
                                            <option style="color: #0e0e0e !important;" disabled selected>-- Select strand --</option>
