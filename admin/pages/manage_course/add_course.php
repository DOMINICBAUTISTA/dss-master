        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">book</i> Add strand</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                            <!-- end displaying -->
                            <form id="form_advanced_validation" action="../../functions/manage_course/add_course.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="help-info">Ex. HUMSS (Humanities and Social Sciences)</div>

                                </div>

                                <input class="btn bg-red" type="submit" name="submit" value="Add course">
                            </form>
                        </div>
                    </div>
                </div>
