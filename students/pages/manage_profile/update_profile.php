...
$student_details = "SELECT student_email, student_fullname, student_no, student_profile, student_password, student_address, student_contact FROM tbl_student WHERE student_id = ?";
...
$students_password = $students['student_password'];
$students_address = $students['student_address'];
$students_contact = $students['student_contact'];
            ...
            <div class="tab-content">
                <div role="tabpanel" id="skins">
                    <ul style="list-style-type: none;">
                        <li>
                            <a href="update_profile.php" style="font-weight: 900; font-size: 15px; text-decoration: none; cursor: pointer; color: black"><i class="material-icons mr-2" style="font-size: 18px; vertical-align: middle;">lock</i> Update profile</a>
                        </li>
                    </ul>
                    <ul style="list-style-type: none;">
                        <li>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <ol class="breadcrumb breadcrumb-col-red">
                    ...
                    <li class="active"><i class="material-icons">groups</i> Update profile</li>
                </ol>
            </div>
            <!-- Advanced Validation -->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                            <!-- end displaying -->
                            <form id="form_advanced_validation" action="../../functions/manage_profile/update_profile.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="student_id" value="<?php echo $student_id ?>">

                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input style="color: gray" type="text" class="form-control" value="<?php echo $students_no ?>" readonly>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input style="color: gray" type="text" class="form-control" value="<?php echo $students_name ?>" readonly>
                                        <label class="form-label">Fullname</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input style="color: gray" type="text" class="form-control" value="<?php echo $students_email ?>" readonly>
                                        <label class="form-label">Email</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input style="color: gray" type="text" class="form-control" value="<?php echo $students_address ?>" readonly>
                                        <label class="form-label">Address</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input style="color: gray" type="number" class="form-control" value="<?php echo $students_contact ?>" maxlength="11" readonly>
                                        <label class="form-label">Phone number</label>
                                    </div>
                                    <div class="help-info" style="color: red; font-weight: 900;">Contact administrator if you want to change this data</div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="student_password" value="<?php echo $students_password ?>" maxlength="20" minlength="6" required>
                                        <label class="form-label">Password</label>
                                    </div>
                                    <div class="help-info">Min.6, Max 20 characters.</div>

                                </div>
                                <input class="btn bg-red" type="submit" name="submit" value="Update password">
                            </form>
                        </div>
                    </div>
                </div>
