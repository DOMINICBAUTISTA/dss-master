    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="../../../images/profile_picture/<?php echo $student_data['student_profile'] ?>" alt="">
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6"><label class="labels" style="font-weight: 900;">Academic Year</label>
                            <p style="color: #2364a3; font-weight: 900;"><?php echo $student_data['academic_year'] ?></p>
                        </div>
                        <div class="col-md-6"><label class="labels" style="font-weight: 900;">Semester</label>
                            <p style="color: #2364a3; font-weight: 900;"><?php echo $student_data['semester_name'] ?></p>
                        </div>
                    </div>
                    <div class="row mt-3">
                    <div class="col-md-12"><label class="labels" style="font-weight: 900;">Section name: </label>
                            <p><?php echo $student_data['section_name'] ?></p>
                        </div>
        ...
        <div class="p-3 py-5">
            ...
            <br>
            <img src="../../../home-assets/images/divine-logo.jpg" style="width: 360px; height: 350px" alt="">
        </div>
    </div>
        </div>
    </div>
